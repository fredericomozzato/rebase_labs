  ...
  describe '#select_all' do
    it 'Retorna todos os tipos de teste do banco de dados' do
      ...
      all_types = ConnectionService.with_pg_conn do |conn|
        ...
        test1 = tests_repo.save(Test.new(token: '123456',
                                         date: '2024-03-08',
                                         patient_id: patient1.id,
                                         doctor_id: doctor1.id))
        test2 = tests_repo.save(Test.new(token: '654321',
                                         date: '2024-03-07',
                                         patient_id: patient2.id,
                                         doctor_id: doctor2.id))
        test_type1 = test_types_repo.save(TestType.new(
          type: 'plaquetas', range: '18-99', result: 50, test_id: 1
        ))
        test_type2 = test_types_repo.save(TestType.new(
          type: 'hemácias', range: '34-128', result: 99, test_id: 1
        ))
        test_type3 = test_types_repo.save(TestType.new(
          type: 'glicose', range: '48-70', result: 89, test_id: 2
        ))
        test_type4 = test_types_repo.save(TestType.new(
